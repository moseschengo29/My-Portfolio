        ...
        <div className="max-w-[1800px] mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start mb-24">
            ...
            <div className="max-w-3xl">
              <h2 className="reveal-text text-5xl md:text-8xl font-bold tracking-tighter mb-12 leading-[0.9]">
                Let&apos;s make something <span className="text-gray-600">impossible.</span>
              </h2>
              <a 
                href="mailto:hello@moseschengo.com" 
                className="reveal-text text-[#e7e6d9] inline-block border border-white/20 px-8 py-4 rounded-full text-xl md:text-2xl font-mono hover:bg-[#e7e6d9] hover:text-red-400 hover:border-gray-400 transition-all duration-300 group"
              >
            ...
            <div className="mt-16 md:mt-0 flex gap-20 font-mono text-sm uppercase tracking-widest">
              <div className="flex flex-col gap-6 reveal-text">
          ...
          <div className="flex justify-between items-end border-t border-white/10 pt-10">
            ...
            <h1 className="reveal-text text-[12vw] leading-[0.7] font-bold tracking-tighter text-[#1a1a1a] select-none mix-blend-difference">
              CHENGO
            </h1>
            
            <div className="reveal-text hidden md:block text-right font-mono text-xs text-white/40">
